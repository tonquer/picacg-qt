...
class Ui_Setting(object):
    ...
    def retranslateUi(self, Setting):
        ...
        self.label_3.setText(_translate("Setting", "解码器（需重启）"))
        ...
        self.threadSelect.setItemText(0, _translate("Setting", "2"))
        ...
        self.modelSelect.setItemText(0, _translate("Setting", "models-cunet"))
        ...
        self.checkBox.setText(_translate("Setting", "是否启用"))
