...
class Ui_Setting(object):
    def setupUi(self, Setting):
        ...
        self.gridLayout_3.addWidget(self.line_4, 10, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_2, 12, 2, 1, 1)

        self.checkBox = QCheckBox(Setting)
        self.checkBox.setObjectName(u"checkBox")

        self.gridLayout_3.addWidget(self.checkBox, 7, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.preDownNum, 4, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_7, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_6, 14, 2, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_5, 13, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.encodeSelect, 9, 2, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_4, 11, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_8, 6, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.logBox, 15, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_5, 14, 0, 1, 1)
