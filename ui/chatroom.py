...
class Ui_ChatRoom(object):
    def setupUi(self, ChatRoom):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 510, 177))
        ...
        self.gridLayout.addWidget(self.atLabel, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.replyLabel, 3, 0, 1, 1)
