...
"        }        ")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, -1120, 661, 2154))
    ...
    def retranslateUi(self, SettingNew):
        ...
        self.downNoise.setItemText(0, QCoreApplication.translate("SettingNew", u"\u81ea\u52a8", None))
        self.downNoise.setItemText(1, QCoreApplication.translate("SettingNew", u"0", None))
        self.downNoise.setItemText(2, QCoreApplication.translate("SettingNew", u"1", None))
        self.downNoise.setItemText(3, QCoreApplication.translate("SettingNew", u"2", None))
        self.downNoise.setItemText(4, QCoreApplication.translate("SettingNew", u"3", None))
