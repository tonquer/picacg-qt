...
"")
        ...
        self.gridLayout_2.addWidget(self.epsListWidget, 1, 0, 1, 1)
        ...
        self.autorList = TagListWidget(BookInfo)
        ...
        self.description = QPlainTextEdit(BookInfo)
        ...
        self.label_4 = QLabel(BookInfo)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setMaximumSize(QSize(16777215, 40))

        self.horizontalLayout_6.addWidget(self.label_4)

        self.categoriesList = TagListWidget(BookInfo)
...
"")
        ...
        self.label_5 = QLabel(BookInfo)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setMaximumSize(QSize(16777215, 40))

        self.horizontalLayout_7.addWidget(self.label_5)

        self.tagsList = TagListWidget(BookInfo)
...
"")
        ...
        self.user_icon = HeadLabel(BookInfo)
        ...
        self.user_name = QLabel(BookInfo)
        self.user_name.setObjectName(u"user_name")

        self.verticalLayout_5.addWidget(self.user_name)

        self.updateTick = QLabel(BookInfo)
        ...
        self.starButton = IconToolButton(BookInfo)
        ...
        self.favoriteButton = IconToolButton(BookInfo)
        ...
        self.commentButton = IconToolButton(BookInfo)
        ...
        self.downloadButton = IconToolButton(BookInfo)
        ...
        self.startRead = QPushButton(BookInfo)
