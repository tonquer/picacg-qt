...
from PySide6.QtCore import Qt, QObject, QEvent, QPoint, Signal, QRect
from PySide6.QtGui import QPainter, QFont, QPixmap, QFontMetrics
from PySide6.QtWidgets import QGraphicsView, QFrame, QGraphicsItemGroup, QGraphicsItem, QGraphicsScene, \
    QGraphicsPixmapItem, QGraphicsTextItem, QGraphicsProxyWidget, QLabel, QScroller, QScrollerProperties, \
    QAbstractSlider

from conf import config
from src.qt.com.qt_scroll import QtScroll
from src.qt.com.qtmsg import QtMsgLabel
from src.qt.read.qtreadimg_pool import QtReadImgPoolManager


class QtReadImgView(QGraphicsView, QtScroll):
            ...
            while True:
                ...
                if addValue > 0 and value >= nextPictureSize:
                    if self.readImg.curIndex <= 0:
                        QtMsgLabel().ShowMsgEx(self.readImg, self.tr("已经到第一页"))
                        return
